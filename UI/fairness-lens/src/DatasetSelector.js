        ...
        <>
          ...
          {selectedDataset && (
            <div className="selected-dataset">
              {/* <p>Your selected dataset is: {selectedDataset.name}</p> */}
              ...
              <ul>
                {selectedDataset.attributes.map(attribute => (
                  <li key={attribute.name}>
                    ...
                    <ul>
                      <li>{Object.values(attribute.mapping).join(', ')}</li>
                    </ul>
                  </li>
                ))}
              </ul>
              ...
              <form onSubmit={handleCreateChildDataset}>
                <div>
                  ...
                  <input type="text" id="name" name="name" value={childData.name} onChange={handleInputChange} />
                </div>

                <div>
                  <label htmlFor="number">Number of Samples:</label>
                  <input
                    type="number"
                    id="number"
                    name="number"
                ...
                <button type="submit">Create Your Dataset</button>
              </form>
            </div>
          )}
        </>
